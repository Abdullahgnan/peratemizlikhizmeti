          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl font-bold">
                İstanbul Boş Ev ve İnşaat Sonrası Temizlik
              </h1>
              <p className="text-lg text-gray-700">
                Yeni evinize tertemiz bir başlangıç yapın. İnşaat sonrası ve taşınma öncesi 
                detaylı temizlik hizmetlerimizle tanışın.
              </p>
            ...
            <div className="relative">
              <Image
                src="/images/services/insaat-sonrasi-1.jpg"
                alt="İnşaat Sonrası Temizlik - Örnek Çalışma"
                width={400}
                height={300}
                loading="lazy"
